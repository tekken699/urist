...
PARTNER_FIELD_LABELS = {
    "name": "Краткое название (напр. «ИП Хлебкин В.А.»)",
    "full_fio": "Полное ФИО в дательном падеже (напр. «Хлебкину Андрею Александровичу»)",
    "inn": "ИНН",
    "ogrnip": "ОГРНИП",
    "address": "Юридический адрес",
    "email": "E-mail",
    "phone": "Телефон",
    "dkk_number": "Номер договора коммерческой концессии (напр. «28022024»)",
